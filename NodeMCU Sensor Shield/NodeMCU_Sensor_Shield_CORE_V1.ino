...
//
// This sketch listens on the hardware serial port for a request to read a sensor or list of sensors
// and responds with sensor data in the following format:
// 
//       Sensor type       | Sensor # | Sensor Reading | Reading Seperator |  End of Request Character
// ---------------------------------------------------------------------------------------------------
//   u Ultrasonic          |   1-4    | reading in CM  |        ,          |           e
//   p Passive Infra-red   |   1-4    | true or false  |                   |
//
// Example reading:
// u1104,u250,u30,u412,p11,p20,p30,p41e
//
// Sensor data can be requested by transmitting a request to the seria port, specifying individual sensors to be
// read or by specifying all sensors of a particular type be read
//
// Request examples:
...
// 
// Requests must end in CR or NL an CR characters
// The maximum number of readings per second is limited by the baud rate of the serial connection (115200bps) and

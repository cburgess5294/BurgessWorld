 ...
 * 
 * The Software Serial port is configured for a BAUD rate of 57600.  Using a higher BAUD rate
 * can introduce errors due to limitations of the ESP8266 architecture
 * 
 * The RUN/PROG switch on the Sensor Shield must be in the RUN position to query the board
 * 
 * See the notes in sketch NodeMCU_Sensor_Shield_CORE_V1.ino for complete details on usage
 */
